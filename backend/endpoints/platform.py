...
async def add_platforms(request: Request) -> PlatformSchema:
    ...
    try:
        fs_platforms_handler.add_platforms(fs_slug=fs_slug)
...
def get_platforms(request: Request) -> list[PlatformSchema]:
    ...
    return db_platforms_handler.get_platforms()
...
def get_supported_platforms(request: Request) -> list[PlatformSchema]:
    ...
    supported_platforms = []
    db_platforms: list = db_platforms_handler.get_platforms()
...
async def delete_platforms(request: Request, id: int) -> MessageResponse:
    ...
    platform = db_platforms_handler.get_platforms(id)
    if not platform:
    ...
    db_platforms_handler.delete_platform(id)
