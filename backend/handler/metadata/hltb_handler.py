...
class HLTBMetadata(TypedDict):
    main_story: NotRequired[int]  # Time in seconds
    main_plus_extra: NotRequired[int]  # Time in seconds
    completionist: NotRequired[int]  # Time in seconds
    all_styles: NotRequired[int]  # Time in seconds
