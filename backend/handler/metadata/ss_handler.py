...
SLUG_TO_SS_PLATFORM: dict[str, SlugToSSId] = {
    "3do": {"id": 29, "name": "3DO"},
    "3ds": {"id": 17, "name": "Nintendo 3DS"},
    "acornelectron": {"id": 85, "name": "Electron"},
    "amiga": {"id": 64, "name": "Amiga"},
    "amigacd32": {"id": 134, "name": "Amiga CD"},
    "amstradcpc": {"id": 60, "name": "Amstrad CPC"},
    "android": {"id": 63, "name": "Android"},
    "apple2": {"id": 86, "name": "Apple II"},
    "apple2gs": {"id": 217, "name": "Apple IIGS"},
    "arcadia": {"id": 94, "name": "Arcadia 2001"},
    ...
    "atarist": {"id": 42, "name": "Atari ST"},
    "atom": {"id": 36, "name": "Atom"},
    "bbcmicro": {"id": 37, "name": "BBC Micro"},
    "c128": {"id": 66, "name": "Commodore 64"},
    "c16": {"id": 99, "name": "Plus/4"},
    "c20": {"id": 73, "name": "Vic-20"},
    "c64": {"id": 66, "name": "Commodore 64"},
    "camplynx": {"id": 88, "name": "Camputers Lynx"},
    "cdi": {"id": 133, "name": "CD-i"},
    "cdtv": {"id": 129, "name": "Amiga CDTV"},
    "channelf": {"id": 80, "name": "Channel F"},
    "coco": {"id": 144, "name": "TRS-80 Color Computer"},
    ...
    "cplus4": {"id": 99, "name": "Commodore Plus/4"},
    "creativision": {"id": 241, "name": "CreatiVision"},
    "dos": {"id": 135, "name": "PC Dos"},
    "dragon32": {"id": 91, "name": "Dragon 32/64"},
    "dreamcast": {"id": 23, "name": "Dreamcast"},
    "dsi": {"id": 15, "name": "Nintendo DSi"},
    "egpc": {"id": 95, "name": "Game Pocket Computer"},
    "exelvision": {"id": 96, "name": "EXL 100"},
    "exidysorcerer": {"id": 165, "name": "Exidy"},
    "famicom": {"id": 3, "name": "NES"},
    "fm7": {"id": 97, "name": "FM-7"},
    "fmtowns": {"id": 253, "name": "FM Towns"},
    "gameandwatch": {"id": 52, "name": "Game & Watch"},
    "gamecom": {"id": 121, "name": "Game.com"},
    ...
    "jupiterace": {"id": 126, "name": "Jupiter Ace"},
    "linux": {"id": 145, "name": "Linux"},
    "loopy": {"id": 98, "name": "Loopy"},
    "lynx": {"id": 28, "name": "Lynx"},
    "mac": {"id": 146, "name": "Mac OS"},
    "macintosh": {"id": 146, "name": "Mac OS"},
    "megadrive": {"id": 1, "name": "Megadrive"},
    "msx": {"id": 113, "name": "MSX"},
    "n64": {"id": 14, "name": "Nintendo 64"},
    "nds": {"id": 15, "name": "Nintendo DS"},
    "neogeoaes": {"id": 142, "name": "Neo-Geo"},
    "neogeocd": {"id": 70, "name": "Neo-Geo CD"},
    "neogeomvs": {"id": 68, "name": "Neo-Geo MVS"},
    "nes": {"id": 3, "name": "NES"},
    "ngage": {"id": 30, "name": "N-Gage"},
    "ngc": {"id": 13, "name": "GameCube"},
    "ngp": {"id": 25, "name": "Neo-Geo Pocket"},
    "ngpc": {"id": 82, "name": "Neo-Geo Pocket Color"},
    "odyssey2": {"id": 104, "name": "Videopac G7000"},
    "oric": {"id": 131, "name": "Oric 1 / Atmos"},
    "palmos": {"id": 219, "name": "Palm OS"},
    "pc88": {"id": 221, "name": "NEC PC-8801"},
    "pc98": {"id": 208, "name": "NEC PC-9801"},
    "pcengine": {"id": 31, "name": "PC Engine"},
    "pcenginecd": {"id": 114, "name": "PC Engine CD-Rom"},
    "pcfx": {"id": 72, "name": "PC-FX"},
    "pet": {"id": 240, "name": "PET"},
    "pico": {"id": 250, "name": "Sega Pico"},
    "pico8": {"id": 234, "name": "Pico-8"},
    "pokemini": {"id": 211, "name": "Pokémon mini"},
    ...
    "pv1000": {"id": 74, "name": "PV-1000"},
    "samcoupe": {"id": 213, "name": "MGT SAM Coupé"},
    "saturn": {"id": 22, "name": "Saturn"},
    "scv": {"id": 67, "name": "Super Cassette Vision"},
    "sega32x": {"id": 19, "name": "Megadrive 32X"},
    ...
    "superacan": {"id": 100, "name": "Super A'can"},
    "supergrafx": {"id": 105, "name": "PC Engine SuperGrafx"},
    "supervision": {"id": 207, "name": "Watara Supervision"},
    "switch": {"id": 225, "name": "Switch"},
    "thomsonmo": {"id": 141, "name": "Thomson MO/TO"},
    "ti99": {"id": 205, "name": "TI-99/4A"},
    "vectrex": {"id": 102, "name": "Vectrex"},
    "vg5000": {"id": 261, "name": "Philips VG 5000"},
    "videopacplus": {"id": 104, "name": "Videopac G7000"},
    ...
    "wswan": {"id": 45, "name": "WonderSwan"},
    "wswanc": {"id": 46, "name": "WonderSwan Color"},
    "x1": {"id": 220, "name": "Sharp X1"},
    "x55": {"id": 112, "name": "Type X"},
    "x68000": {"id": 79, "name": "Sharp X68000"},
    "xbox": {"id": 32, "name": "Xbox"},
    "xbox360": {"id": 33, "name": "Xbox 360"},
    "xboxone": {"id": 34, "name": "Xbox One"},
    "zmachine": {"id": 215, "name": "Z-Machine"},
