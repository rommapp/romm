...
MOBYGAMES_PLATFORM_LIST: dict[str, SlugToMobyId] = {
    ...
    "dos": {"id": 2, "name": "DOS"},
    "dragon-32-slash-64": {"id": 79, "name": "Dragon 32/64"},
    ...
    "gamegear": {"id": 25, "name": "Game Gear"},
    "gamestick": {"id": 155, "name": "GameStick"},
    "gb": {"id": 10, "name": "Game Boy"},
    "gba": {"id": 12, "name": "Game Boy Advance"},
    "gbc": {"id": 11, "name": "Game Boy Color"},
    ...
    "microvision--1": {"id": 97, "name": "Microvision"},
    ...
    "neogeoaes": {"id": 36, "name": "Neo Geo"},
    "neogeomvs": {"id": 36, "name": "Neo Geo"},
    "nes": {"id": 22, "name": "NES"},
    ...
    "sega32": {"id": 21, "name": "SEGA 32X"},
    "segacd": {"id": 20, "name": "SEGA CD"},
    "series-x-s": {"id": 289, "name": "Xbox Series X/S"},
    ...
    "sinclair-zx81": {"id": 119, "name": "ZX81"},
    "sk-vm": {"id": 259, "name": "SK-VM"},
    "smc-777": {"id": 273, "name": "SMC-777"},
    "sms": {"id": 26, "name": "SEGA Master System"},
    ...
    "trs-80-color-computer": {"id": 62, "name": "TRS-80 Color Computer"},
    ...
    "turbografx16--1": {"id": 40, "name": "TurboGrafx-16"},
