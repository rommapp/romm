...
class DBRomsHandler(DBBaseHandler):
    ...
    def _filter_by_platform_ids(
        self, query: RomSelect, platform_ids: Sequence[int]
    ) -> RomSelect:
        return query.filter(Rom.platform_id.in_(platform_ids))

    def _filter_by_collection_id(
        self, query: RomSelect, collection_id: int
    ) -> RomSelect:
    ...
    def _filter_by_virtual_collection_id(
        self, query: RomSelect, virtual_collection_id: str
    ) -> RomSelect:
    ...
    def _join_rom_user(self, query: RomSelect, user_id: int | None) -> RomSelect:
        if not user_id:
            return query
    ...
    def _filter_by_search_term(self, query: RomSelect, search_term: str) -> RomSelect:
    ...
    def _filter_by_matched(self, query: RomSelect, value: bool) -> RomSelect:
    ...
    def _filter_by_favorite(
        self, query: RomSelect, value: bool, user_id: int | None
    ) -> RomSelect:
    ...
    def _filter_by_duplicate(self, query: RomSelect, value: bool) -> RomSelect:
    ...
    def _filter_by_playable(self, query: RomSelect, value: bool) -> RomSelect:
    ...
    def _filter_by_last_played(
        self, query: RomSelect, value: bool, user_id: int | None = None
    ) -> RomSelect:
    ...
    def _filter_by_has_ra(self, query: RomSelect, value: bool) -> RomSelect:
    ...
    def _filter_by_missing_from_fs(self, query: RomSelect, value: bool) -> RomSelect:
    ...
    def _filter_by_verified(self, query: RomSelect, value: bool) -> RomSelect:
        keys_to_check = [
            "tosec_match",
            "mame_arcade_match",
            "mame_mess_match",
