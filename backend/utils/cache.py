...
try:
    use_redis_connection = redis_client.ping() and ENABLE_EXPERIMENTAL_REDIS
except ConnectionError:
    use_redis_connection = False
...
cache = _cache_client if use_redis_connection else _fallback_cache
