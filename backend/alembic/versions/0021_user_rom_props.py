...
def upgrade() -> None:
    ...
    op.execute(
        """
        INSERT INTO user_rom_props (id, updated_at, note_raw_markdown, note_is_public, is_main_sibling, rom_id, user_id)
        SELECT id, updated_at, raw_markdown, is_public, NULL, rom_id, user_id
        FROM rom_notes
    """
    )
