...
``character_set_collations`` setting. Each operand goes through ``CONVERT(...
USING utf8mb4)`` first, because an explicit utf8mb4 collation on a utf8mb3
value is rejected outright and both literals and JSON_TABLE columns are utf8mb3
on a server configured with ``--character-set-server=utf8``. No behavior change
on PostgreSQL.
        ...
        sa.text("""
                ...
                genres AS (
                    SELECT
                        ...
                        CONVERT(j.genre USING utf8mb4) COLLATE utf8mb4_general_ci as collection_name,
                        CONVERT('genre' USING utf8mb4) COLLATE utf8mb4_general_ci as collection_type
                    FROM
                        base
                ...
                franchises AS (
                    SELECT
                        ...
                        base.path_cover_s as path_cover_s,
                        base.path_cover_l as path_cover_l,
                        CONVERT(j.franchise USING utf8mb4) COLLATE utf8mb4_general_ci as collection_name,
                        CONVERT('franchise' USING utf8mb4) COLLATE utf8mb4_general_ci as collection_type
                    FROM
                        base
                        CROSS JOIN JSON_TABLE(
                            base.franchises,
                ...
                collections AS (
                    SELECT
                        ...
                        base.path_cover_s as path_cover_s,
                        base.path_cover_l as path_cover_l,
                        CONVERT(j.collection USING utf8mb4) COLLATE utf8mb4_general_ci as collection_name,
                        CONVERT('collection' USING utf8mb4) COLLATE utf8mb4_general_ci as collection_type
                    FROM
                        base
                        CROSS JOIN JSON_TABLE(
                            base.collections,
                ...
                modes AS (
                    SELECT
                        ...
                        base.path_cover_s as path_cover_s,
                        base.path_cover_l as path_cover_l,
                        CONVERT(j.mode USING utf8mb4) COLLATE utf8mb4_general_ci as collection_name,
                        CONVERT('mode' USING utf8mb4) COLLATE utf8mb4_general_ci as collection_type
                    FROM
                        base
                        CROSS JOIN JSON_TABLE(
                            base.game_modes,
                ...
                companies AS (
                    SELECT
                        ...
                        base.path_cover_s as path_cover_s,
                        base.path_cover_l as path_cover_l,
                        CONVERT(j.company USING utf8mb4) COLLATE utf8mb4_general_ci as collection_name,
                        CONVERT('company' USING utf8mb4) COLLATE utf8mb4_general_ci as collection_type
                    FROM
                        base
                        CROSS JOIN JSON_TABLE(
                            base.companies,
                ...
                SELECT
                    ...
                    CONVERT(CONCAT('Autogenerated ', collection_name, ' collection') USING utf8mb4) COLLATE utf8mb4_general_ci AS description,
                    NOW() AS created_at,
                    NOW() AS updated_at,
