...
def upgrade() -> None:
    ...
    with op.batch_alter_table("roms", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("regions", CustomJSON(), nullable=True), if_not_exists=True
        )
        batch_op.add_column(
            sa.Column("languages", CustomJSON(), nullable=True), if_not_exists=True
        )
    ...
    with op.batch_alter_table("roms", schema=None) as batch_op:
        ...
        batch_op.drop_column("region", if_exists=True)
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("roms", schema=None) as batch_op:
        ...
        batch_op.drop_column("languages", if_exists=True)
        batch_op.drop_column("regions", if_exists=True)
