...
const { xs, sm, mdAndUp, mdAndDown, lgAndUp } = useDisplay()
...
<template>
    ...
    <div :class="{'content': lgAndUp, 'content-tablet': mdAndDown, 'content-mobile': xs}" v-if="rom !== undefined">
        <v-row class="pt-8 justify-center">
            ...
            <v-col :class="{'cover': mdAndUp, 'cover-tablet': sm, 'cover-mobile': xs}">
                    <v-row>
                        <v-col>
                            <v-card elevation="5" :loading="downloading.value.includes(rom.file_name) ? 'rommAccent1': null">
            ...
            <v-col class="mt-10" :class="{'info': mdAndUp, 'info-tablet': sm, 'info-mobile': xs}">
                ...
                <div :class="{'details-content': mdAndUp, 'details-content-tablet': sm, 'details-content-mobile': xs}">
    ...
    <v-dialog v-model="dialogSearchRom" scroll-strategy="none" width="auto" :scrim="false" v-if="rom !== undefined">
        <v-card :class="{'search-content': mdAndUp, 'search-content-tablet': sm, 'search-content-mobile': xs}">
            ...
            <v-toolbar density="comfortable" class="bg-primary">
                <v-row class="align-center" no-gutters>
                    <v-col cols="9" xs="9" sm="10" md="11" lg="11">
            ...
            <v-toolbar density="compact" class="bg-primary">
                <v-row class="align-center" no-gutters>
                    <v-col cols="6" xs="8" sm="8" md="8" lg="9">
                        <v-text-field
                    ...
                    <v-col cols="3" xs="2" sm="2" md="2" lg="2">
            ...
            <v-card-text class="pt-1 pl-2 pr-2 scroll justify-center align-center bg-secondary">
    ...
    <v-dialog v-model="dialogEditRom" scroll-strategy="none" width="auto" :scrim="false" v-if="rom !== undefined">
        <v-card rounded="0" :class="{'edit-content': mdAndUp, 'edit-content-tablet': sm, 'edit-content-mobile': xs}">
            <v-toolbar density="comfortable" class="bg-primary">
                <v-row class="align-center" no-gutters>
                    <v-col cols="9" xs="9" sm="10" md="11" lg="11">
                        <v-icon icon="mdi-pencil-box" class="ml-3"/>
                    </v-col>
                    <v-col>
    ...
    <v-dialog v-model="dialogDeleteRom" width="auto" v-if="rom !== undefined">
        <v-card rounded="0" :class="{'delete-content': mdAndUp, 'delete-content-tablet': sm, 'delete-content-mobile': xs}">
            <v-toolbar density="comfortable" class="bg-primary">
                <v-row class="align-center" no-gutters>
                    <v-col cols="9" xs="9" sm="10" md="11" lg="11">
                        <v-icon icon="mdi-delete" class="ml-3"/>
                    </v-col>
                    <v-col>
            ...
            <v-card-text class="bg-secondary">
                <v-row class="justify-center ma-2">
                    <span>Deleting {{ rom.file_name }} from RomM. Do you confirm?</span>
                </v-row>
...
.details-content{ margin-top: 110px; max-width: 700px; }
.details-content-tablet { margin-top: 54px; }
.details-content-mobile{ margin-top: 40px; }
.loader-searching { margin-top: 200px; }
.no-results-searching { margin-top: 150px; }
.search-content{ width: 900px; height: 640px;}
.search-content-tablet{ width: 550px; height: 550px; }
.search-content-mobile{ width: 85vw; height: 620px; }
.edit-content{ width: 700px; }
.edit-content-tablet{ width: 500px; }
.edit-content-mobile{ width: 85vw; }
.delete-content{ width: 700px; }
.delete-content-tablet{ width: 500px; }
