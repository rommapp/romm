...
<template>
  ...
  >
    ...
    <template #content>
      ...
      <!-- <v-row v-if="!searching" v-for="game in games" no-gutters>
        <v-col v-if="game.resources && game.resources?.length > 0">
          <v-row no-gutters>
            <v-col>
              <v-list-item>{{ game.name }}</v-list-item>
            </v-col>
          </v-row>
          <v-row no-gutters>
            <v-col
          ...
          <v-row no-gutters class="text-center mt-1">
            <v-col>
              <v-btn variant="outlined" color="romm-accent-1">Load more</v-btn>
            </v-col>
          </v-row>
