...
export default defineStore("roms", {
  ...
  actions: {
    ...
    setRecentPlayedRoms(roms: SimpleRom[]) {
      this.recentPlayedRoms = roms;
    },
    ...
    addToRecentPlayed(rom: SimpleRom) {
      this.recentPlayedRoms = [rom, ...this.recentPlayedRoms];
    },
