...
// NotificationInbox: the signed-in user's notifications. Whatever it shows is
// marked read, and a row that was unread keeps its accent until the user leaves.
...
<style scoped>
/* The SettingsLayout content column owns the gutters. */
.r-v2-notifications {
  display: flex;
